...
for name in galay-kernel galay-utils galay-ssl galay-http galay-tracing galay-rpc galay-mysql galay-mongo galay-redis galay-mail galay-mcp galay-etcd; do
    build_source "$name"
done
